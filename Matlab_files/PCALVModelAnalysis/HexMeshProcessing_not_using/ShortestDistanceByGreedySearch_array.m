function nodeDistance = ShortestDistanceByGreedySearch_array(heart_node,endoSurf,epiSurf, epiB, endoB, innerB)
...
for inode = 1 : Nnode
    ...
    elseif heart_node(inode,5) == innerB
        ...
        %[indexEndo dendo] = DistanceFromPointToSurface(p,endoSurf,heart_node, innerB);
        %[indexEpi depi]   = DistanceFromPointToSurface(p,epiSurf, heart_node, innerB);
