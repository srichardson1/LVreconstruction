...
TMeshLibmesh = TMesh;
epiID = 4096; endoID = 4097; baseID = 4098; % standard
%epiID = 4852; endoID = 4852; baseID = 1260;
...
TMesh(endofaceS1(i),2)
TMesh(endofaceS1(i),3)
TMesh(endofaceS1(i),4)
TMesh(endofaceS1(i),5)
end
for i = 1 : length(endofaceS3)
