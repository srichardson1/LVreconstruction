...
function All_fitting_reconstruction(pat_id)
...
%}
PathName=strcat('/Users/alan/ownCloud/Shared/segmentations_mi_HGShare/Results/HV',pat_id) %alan added
%projectConfig_name = FileName(1:end-2)
projectConfig_name = strcat('LVWM_config_HV',pat_id,'_EarlyDia') %alan added
