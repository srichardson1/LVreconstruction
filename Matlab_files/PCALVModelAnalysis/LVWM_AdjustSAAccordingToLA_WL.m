...
for scanIndex = 1 : totalScanNo
    ...
    LXSliceSelected = LXSlice(timeInstanceSelected(scanIndex));
    SXSliceSelected = SXSlice(timeInstanceSelected(scanIndex));
...
for scanIndex = 1 : totalScanNo
    ResultsDirAllScans(scanIndex).timeInstanceSelected = timeInstanceSelected(scanIndex);
end
