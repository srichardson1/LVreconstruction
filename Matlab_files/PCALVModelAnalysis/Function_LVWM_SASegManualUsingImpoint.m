function Function_LVWM_SASegManualUsingImpoint(imSelected,projectConfig_dir,projectConfig_name)
%%%SA segmentation
close all; 
clc;
workingDir = pwd();
...
if ~exist('imSelected', 'var')
    ...
    'ListSize', [100,200], 'InitialValue',1);
else
...
try
    ...
    [imCropData, rect] = imcrop(mat2gray(imData));
end
