...
[uvnode, NNode,Nelement,ElementNode] = PartitionUVWLmappedmesh(umax,w0,alpha0,NuMesh,NvMesh,resultDir,workingDir,projectConfig_dir);
...
cd(resultDir);
save XYZEpiFitted XYZEpiFitted XYZEpiApexFitted XYZEpiApex;
cd(workingDir);
