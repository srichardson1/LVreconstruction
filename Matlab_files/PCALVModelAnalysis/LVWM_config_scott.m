global period_time_str total_SA_slices total_number_of_SA_images first_sa_slice_for_config_file matlab_programme_folder_str folder_results_final full_dicom_directory_computed first_directory_name end_systole_time_for_config_file early_diastole_time_for_config_file end_diastole_time_for_config_file

patient_name = first_directory_name;
dicomDir = full_dicom_directory_computed;
resultDir = folder_results_final;
workingDir= matlab_programme_folder_str;
resultDirRoot = folder_results_final;
...
total_image_number=str2num(total_number_of_SA_images);
...
patientConfigs(patientIndex,1).totalTimeInstance = total_image_number;


if period_time_str == 'Early diastole'
      patientConfigs(patientIndex,1).timeInstanceSelected = patientConfigs(patientIndex,1).TimeEarlyOfDiastole;
elseif period_time_str == 'End diastole'
