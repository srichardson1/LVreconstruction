...
scaleMM = 10;
abaqusInputFileName = '/Users/scottrichardson/Desktop/Core/Modelling/Results/empa002/002c/endDiastole/abaqusInputData.mat';
%%%% load parameter for one study
cd(resultDir);
%SetParameters;
load '/Users/scottrichardson/Desktop/Core/Modelling/Results/empa002/002c/endDiastole/abaqusInputData.mat';
cd('./fibreGeneration');
abaqusFiberDir = '/Users/scottrichardson/Desktop/Core/Modelling/Results/empa002/002c/endDiastole/fibreGeneration';
cd(workingDir);
...
WriteAbaqusMeshInput(abaqusInputData, abaqusInputFileName, abaqusFiberDir,workingDir);
